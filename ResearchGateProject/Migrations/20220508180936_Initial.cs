        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikeId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUsers_Papers", x => new { x.ApplicationUserId, x.PaperId });
                    table.ForeignKey(
                        name: "FK_ApplicationUsers_Papers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUsers_Papers_Papers_PaperId",
                        column: x => x.PaperId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsers_Papers_PaperId",
                table: "ApplicationUsers_Papers",
                column: "PaperId");
